 ...
 */
public class BinaryBytesHttpRequestEditorProvider implements HttpRequestEditorProvider {
     ...
     */
    public BinaryBytesHttpRequestEditorProvider(MontoyaApi api) {
        this._montoya = api;
    }
    ...
    public ExtensionProvidedHttpRequestEditor provideHttpRequestEditor(EditorCreationContext editorContext) {
        return new BinaryBytesHttpRequestEditor(this._montoya, editorContext.editorMode());
    }
}
