 ...
 */
public class BinaryBytesHttpResponseEditorProvider implements HttpResponseEditorProvider {
     ...
     */
    public BinaryBytesHttpResponseEditorProvider(MontoyaApi api) {
        this._montoya = api;
    }
    ...
    public ExtensionProvidedHttpResponseEditor provideHttpResponseEditor(EditorCreationContext editorContext) {
        return new BinaryBytesHttpResponseEditor(this._montoya, editorContext.editorMode());
    }
}
